// Importing all images and components needed for the Invest page
import main1 from "../assets/images/main1.png"; // Main hero image
import investors from "../assets/images/investors.png"; // Investors section image
import explore from "../assets/images/explore.png"; // Explore section image
import estate from "../assets/images/estate.png"; // Estate section image
import PiggyBtn from "../components/reusable/PiggyBtn"; // Custom button component
import { FaApple, FaGooglePlay } from "react-icons/fa"; // Icons for app download buttons
import woman from "../assets/images/woman.png"; // Woman illustration
import twentyOne from "../assets/images/twentyOne.png"; // Opportunity images
...
import HouseInvest from "../components/block/housemoney/HouseInvest"; // Custom component for house investment section

// The Invest component represents the main investment landing page
// It is a React functional component
const Invest = () => {
  // The return statement describes what will be rendered on the page
  return (
    // The outermost div sets the minimum height and background color using Tailwind classes
    <div className="min-h-screen w-full bg-[#f2f7f8]">
      {/* Main content container, centers content and sets responsive width */}
      <div className="mx-auto max-md:w-[100%]" style={{ backgroundColor: "#F2F7F8" }}>
        ...
        <section className="flex justify-between items-center max-w-[1280px] px-16 pt-[150px] max-md:flex-col" style={{ backgroundColor: "hsl(269, 85%, 49%)" }}>
          ...
          <div className="text-white max-md:w-[100%]">
            ...
            {/* Highlighted returns info */}
            <span className="bg-white text-xl mb-8 inline-block px-6 py-3 rounded-4xl max-md:mx-auto" style={{ color: "hsl(269, 85%, 49%)", backgroundColor: "#EFF5FC" }}>
              Up to 35% returns
            </span>
            {/* Short description about investing */}
            <p className="w-2/3 text-2xl mb-6">
              Invest securely and confidently on the go. Up to 35% returns, 6-12 month duration.
            </p>
            {/* App download buttons for iPhone and Android */}
