  ...
  return (
    <div className="min-h-screen w-full bg-[#f2f7f8]">
      ...
      <section className="w-full" style={{ background: '#7913e5' }}>
        <div className="flex flex-row max-w-[1280px] mx-auto px-16 pt-[150px] items-center pb-[130px] flex-wrap max-md:max-w-[100%] max-md:flex-col max-md:gap-y-[50px]">
          ...
          <div className="flex-1 flex justify-center items-center min-w-[300px] mt-8 md:mt-0">
            <img src={main1} alt="Invest" className="max-h-[400px] w-auto object-contain" />
          </div>
        </div>
      </section>
