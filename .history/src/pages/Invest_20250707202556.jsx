    ...
    <div className="min-h-screen w-full bg-[#f2f7f8]">
      ...
      <div className="mx-auto max-md:w-[100%]" style={{ backgroundColor: "#F2F7F8" }}>
        ...
        <section
          ...
          style={{ backgroundColor: "hsl(269, 85%, 49%)", minWidth: '100vw', width: '100vw', height: '52vh', maxWidth: '1250vw' }}
        >
          <div
            className="space-y-6 flex flex-col justify-center"
            style={{ width: '600px', height: '273px', marginLeft: '250px', marginRight: '20px' }}
          >
