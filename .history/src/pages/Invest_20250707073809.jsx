...
const Invest = () => {
  // The invest page gets a full-width purple background
  // The header is fixed and overlays the hero section
  return (
    <div className="invest-bg min-h-screen w-full">
      {/* Integrate the custom header for the Invest page */}
      <Header />
      {/* Add padding to account for fixed header */}
      <div className="invest-content mx-auto max-md:w-[100%]">
        {/* Hero Section: full width, purple background */}
        <section
