  ...
  return (
    ...
    <div className="min-h-screen w-full bg-[#f2f7f8]">
      ...
      <div className="mx-auto max-md:w-[100%]" style={{ backgroundColor: "#F2F7F8" }}>
        ...
        <section
          className="w-screen relative left-1/2 right-1/2 -mx-[50vw] flex justify-center items-center mb-24"
          style={{ backgroundColor: "hsl(269, 85%, 49%)", minWidth: '100vw', width: '100vw', height: '80vh' }}
        >
          <div
