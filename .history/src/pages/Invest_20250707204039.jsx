    ...
    <div className="min-h-screen w-full bg-[#f2f7f8]">
      ...
      <div className="mx-auto max-md:w-[100%]" style={{ backgroundColor: "#F2F7F8" }}>
        ...
        <section
          ...
          style={{ backgroundColor: "hsl(269, 85%, 49%)", minWidth: '103vw', width: '100vw', height: '454vh', maxWidth: '100vw', position: 'fixed', top: 0, left: 0, zIndex: 50 }}
        >
          <div
          ...
          <div style={{ flex: 1, display: 'flex' }}>
            ...
            <img
              src={woman}
              alt=""
              style={{ width: '625px', height: '439px', objectFit: 'cover', boxShadow: '0 10px 25px rgba(0,0,0,0.15)' }}
            />
          </div>
        </section>
      </div>
