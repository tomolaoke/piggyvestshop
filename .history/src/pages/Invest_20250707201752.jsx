    ...
    <div className="min-h-screen w-full bg-[#f2f7f8]">
      ...
      <div className="mx-auto max-md:w-[100%]" style={{ backgroundColor: "#F2F7F8" }}>
        ...
        <section
          ...
          style={{ backgroundColor: "hsl(269, 85%, 49%)", minWidth: '100vw', width: '100vw', height: '600vh', maxWidth: '100vw' }}
        >
          <div
            className="space-y-6 ml-20 flex flex-col justify-center"
            style={{ width: '600px', height: '273px' }}
          >
          ...
          <div className="flex-1 flex justify-end pr-20 items-center">
            <img
              src={woman}
              alt=""
              style={{ width: '625px', height: '445px', objectFit: 'cover', boxShadow: '0 10px 25px rgba(0,0,0,0.15)' }}
            />
          </div>
        </section>
      </div>
