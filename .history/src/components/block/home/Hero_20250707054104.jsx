          ...
          <section className="max-w-[550px] relative max-md:max-w-[95%] max-md:mx-auto">
            ...
            <main>
              ...
              <img
                ...
                alt="Decorative 1"
                className="h-[60px] absolute left-[-14%] top-[75px] w-auto animate-bounce-slow"
              />
              {/* Top right decorative image */}
              <img
                src="/images/image2.png"
                alt="Decorative 2"
                className="h-[85px] absolute right-[-8%] top-[45px] w-auto animate-bounce-slow"
              />
              {/* Middle left decorative image */}
              <img
                src="/images/image3.png"
                alt="Decorative 3"
                className="h-[75px] absolute left-[-11%] top-[240px] w-[212px] animate-bounce-slow"
              />
              {/* Middle right decorative image */}
              <img
                src="/images/image4.png"
                alt="Decorative 4"
                className="h-[65px] absolute right-[-10%] top-[280px] w-auto animate-bounce-slow"
              />
              {/* Bottom left decorative image */}
              <img
                src="/images/image5.png"
                alt="Decorative 5"
                className="h-[70px] absolute left-[-11%] top-[430px] w-[180px] animate-bounce-slow"
              />
              {/* Bottom right decorative image */}
              <img
                src="/images/image6.png"
                alt="Decorative 6"
                className="h-[75px] absolute right-[-7%] bottom-[-26px] w-auto animate-bounce-slow"
              />
            </main>
          </section>
        </div>
