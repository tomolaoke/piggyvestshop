...
export default function Navbar() {
  ...
  return (
    <div className={`w-[100%] fixed z-100 transition-colors duration-300 ${scrolled ? 'bg-white' : 'bg-[#f2f7f8]'}`}>
      <div className={`w-[100%] flex justify-between items-center max-w-[1200px] mx-auto py-[20px] max-md:hidden transition-colors duration-300 ${scrolled ? 'bg-white' : 'bg-[#f2f7f8]'}`}>
