    ...
    <div className=" shadow shadow-gray-500 w-[100%] fixed bg-white  z-100">
      <div className=" bg-white w-[100%] flex justify-between items-center max-w-[1200px] mx-auto py-[20px]  max-md:hidden  ">
        <div className="w-[70%]  flex justify-between items-center">
          ...
          <div className="flex justify-between items-center w-[70%] gap-x-[2px] font-bold text-[17px] text-[#263142] tracking-tight">
            <div className="">
              <span
                onMouseEnter={() => {
                  setSave(true);
            ...
            <div className="">
              <span
                ...
                className="flex items-center gap-x-[3px] font-bold"
              >
